...
# ════════════════════════════════════════════════════════════════════════════
#  TRAINING CONVERSATION CLASS WITH RAG
# ════════════════════════════════════════════════════════════════════════════

class TrainingConversationWithRAG:
    def __init__(self, persona, company_context, vectorstore=None, model="gpt-4o-mini", tts_voice="shimmer"):
        """
    ...
    def send_message(self, user_message, speak=True):
        ...
        if context:
            context_msg = SystemMessage(
                content=f"Relevant company information:\n{context}"
            )
        ...
        # Save to history (without context injection)
...
def run_interactive_session_with_rag():
    ...
    # Create conversation
    conversation = TrainingConversationWithRAG(
        persona, 
        company_context, 
        vectorstore,
        tts_voice=tts_voice
    ...
    print("Type 'quit' to end | 'mute' to silence | 'unmute' to restore\n")
